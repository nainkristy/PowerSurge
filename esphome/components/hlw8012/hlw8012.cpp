// ORIGINAL: https://github.com/esphome/esphome/blob/dev/esphome/components/hlw8012/hlw8012.cpp
// Code was changed to keep the current measurement active 3 times more than the voltage, since the voltage in this case is stable
#include "hlw8012.h"
...
void HLW8012Component::update() {
  ...
  // Make current take 3 more times than voltage measurement
  if (this->change_mode_every_ != 0 && this->change_mode_at_++ == (this->change_mode_every_*(3 * this->current_mode_ + 1))) {
